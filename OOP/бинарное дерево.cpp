...
//На базе кода бинарного дерева(взятого из урока №9 или высланного в Тимс) 
//создать программу, которая хранит в бинарном дереве ФИО студентов и их средние баллы.